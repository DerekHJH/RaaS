...
def decode_topk(
    ...
    Args:
        ...
        layer_idx: Layer index of the KV cache.
    """
    # excluding the last page; half of the max-pages limited. This pages are then flagged as the top-k pages.
    page_budet = min(iController.inference_page_budget - 1, iController.origin_page_budget // 2)
