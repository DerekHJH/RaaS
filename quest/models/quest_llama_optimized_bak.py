...
from quest.quest_utils import rms_norm_forward
...
class QuestAttention(nn.Module):
    ...
    def forward(
        ...
        iController: Optional[quest.quest_utils.InferenceController] = None,
        ...
        quest.quest_utils.apply_rope_in_place(
            query_states,
            key_states,
        ...
        if q_len > 1:
            ...
            attn_output = quest.quest_utils.prefill_forward(
                query_states,
                iController,
                self.layer_idx,
            )
            ...
            if iController.need_estimate() == False:
                ...
                attn_output = quest.quest_utils.decode_sparse_attn(
                    query_states,
                    iController,
                    self.layer_idx,
                ...
                estimated_attn_score = quest.quest_utils.decode_estimate(
                    query_states,
                    iController,
                    self.layer_idx,
                )
